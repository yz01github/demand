...
public class DemandsController {
    ...
    public ResResult<IPage<DemandsVO>> updateDemandState(@ModelAttribute @Valid QueryDemandVO qryVO, PageVO<DemandInfo> pageVO) {
    ...
    public ResResult<IPage<DemandsVO>> qryAllByCond(@ModelAttribute QueryAllDemandVO qryVO, @ModelAttribute PageVO<DemandInfo> pageVO) {
     ...
     * created 2020/9/10
     */
    @ApiOperation(value="修改需求信息",notes="修改需求信息,无法修改需求状态(忽略状态字段),此功能后期应当列入功能权限")
    @PutMapping("/info")
    public ResResult<Integer> updateDemand(@RequestBody UpdateDemandsVO demandInfo) {
